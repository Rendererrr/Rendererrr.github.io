-- Catapult Launch HUD. The game-thread feature publishes charge state and projected arc points.
features.on_draw("Catapult Launch", function(f)
    ...
    if f.show_charge_meter then
        ...
        local label = string.format("CATAPULT  %d%%", math.floor(charge * 100 + 0.5))
